...
/* D:\OSPanel\domains\sfedu/plugins/wrdn/league/components/seasons/default.htm */
class __TwigTemplate_3f9ceea4a45295c5dad96c6ff997871c43a8726b7a2a9994ac91c039772a623b extends Twig_Template
{
    private $source;
    ...
    {
        // line 1
        $context["seasons"] = twig_get_attribute($this->env, $this->source, ($context["__SELF__"] ?? null), "seasons", array());
        // line 2
        echo "
<div class=\"card my-4\">
    ...
    <div class=\"card-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["season"]) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["season"], "slug", array()), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["season"], "name", array()), "html", null, true);
            echo "</a></p>
        ";
...
";
    ...
    {
        return "D:\\OSPanel\\domains\\sfedu/plugins/wrdn/league/components/seasons/default.htm";
    }
...
{% endif %}", "D:\\OSPanel\\domains\\sfedu/plugins/wrdn/league/components/seasons/default.htm", "");
    }
}
