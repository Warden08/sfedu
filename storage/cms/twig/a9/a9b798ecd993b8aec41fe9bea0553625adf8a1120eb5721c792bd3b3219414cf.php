...
class __TwigTemplate_3cd6c51760859d193d787c1e674e7dafa73dff65b02110e8bbc2126a27e3b1cc extends Twig_Template
{
    private $source;
    ...
    {
        // line 1
        $context["matches_all"] = twig_get_attribute($this->env, $this->source, ($context["__SELF__"] ?? null), "matches", array());
        // line 2
        echo "
<div class=\"card my-4\">
    ...
    <div class=\"card-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["match"]) {
            ...
            echo "        <p>";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["match"], "team1", array()));
            foreach ($context['_seq'] as $context["_key"] => $context["team1"]) {
                // line 8
                echo "                ";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["team1"], "name", array()), "html", null, true);
                echo "
            ";
            }
            ...
            // line 11
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["match"], "team2", array()));
            foreach ($context['_seq'] as $context["_key"] => $context["team2"]) {
                // line 12
                echo "            ";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["team2"], "name", array()), "html", null, true);
                echo "
            ";
            }
            $_parent = $context['_parent'];
...
";
        // line 20
        if ((twig_get_attribute($this->env, $this->source, ($context["matches"] ?? null), "lastPage", array()) > 1)) {
            // line 21
            echo "<ul class=\"pagination\">
    ";
            // line 22
            if ((twig_get_attribute($this->env, $this->source, ($context["matches"] ?? null), "currentPage", array()) > 1)) {
                // line 23
                echo "    <li><a href=\"";
                echo $this->extensions['Cms\Twig\Extension']->pageFilter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", array()), "baseFileName", array()), array(($context["pageParam"] ?? null) => (twig_get_attribute($this->env, $this->source, ($context["matches"] ?? null), "currentPage", array()) - 1)));
                echo "\">&larr; Prev</a></li>
    ";
            }
            // line 25
    ...
    ";
            // line 26
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(range(1, twig_get_attribute($this->env, $this->source, ($context["matches"] ?? null), "lastPage", array())));
    ...
    ";
            // line 32
            if ((twig_get_attribute($this->env, $this->source, ($context["matches"] ?? null), "lastPage", array()) > twig_get_attribute($this->env, $this->source, ($context["matches"] ?? null), "currentPage", array()))) {
                // line 33
                echo "    <li><a href=\"";
                echo $this->extensions['Cms\Twig\Extension']->pageFilter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", array()), "baseFileName", array()), array(($context["pageParam"] ?? null) => (twig_get_attribute($this->env, $this->source, ($context["matches"] ?? null), "currentPage", array()) + 1)));
                echo "\">Next &rarr;</a></li>
